...
The content of this documentation is published at <https://vertx-jenkins.rhev-ci-vms.eng.rdu2.redhat.com//userContent/protean/index.html> (don't ask).  
You can safely hit cancel when a login/password is requested.
