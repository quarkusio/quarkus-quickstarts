...
public class ConsulTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        return Map.of(
                ...
                "quarkus.stork.my-service.service-registrar.consul-host", container.getContainerIpAddress(),
                "quarkus.stork.my-service.service-registrar.consul-port", Integer.toString(container.getMappedPort(8500))
        );
