...
with a front-end based in Angular so you can play with it from your browser.
...
After having set the GraalVM as your JVM, launch the Maven build on
...
> java -jar ./target/hibernate-resteasy-1.0-SNAPSHOT-runner.jar

    Have a look at how fast it boots.
    Or measure total native memory consumption...
    no other framework can match this.
...
> ./target/hibernate-resteasy-1.0-SNAPSHOT-runner
