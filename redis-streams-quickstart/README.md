...
```shell
docker exec -ti redis-streams-quickstart-redis-1 sh -c "redis-cli hgetall temperature-aggregates" 
```
...
```
where the id you can put the id of the weather stations (e.g. 1, 2, ...)
